...
echo " Creating partis politique referentials table"
run_sql_file "//sql/scripts/groups/referentials/ref_partis_politiques.sql"
echo " Creating acteurs photos referentials table"
run_sql_file "//sql/scripts/acteurs/referentials/ref_acteurs_photos.sql"
